...
class ResContextBlock(nn.Module):
    def __init__(self, in_filters, out_filters, kernel_size=(3, 3, 3), stride=1, indice_key=None):
        ...
        self.conv1_2 = conv1x3(out_filters, out_filters, indice_key=indice_key + "bef") #conv3x1(out_filters, out_filters, indice_key=indice_key + "bef")
        ...
        self.conv3 = conv3x1(out_filters, out_filters, indice_key=indice_key + "bef") #conv1x3(out_filters, out_filters, indice_key=indice_key + "bef")

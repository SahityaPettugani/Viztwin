import svgPaths from "./svg-2jbdh7sn74";
...
function UploadFileThing() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute contents left-[calc(50%+5.5px)] top-[calc(50%-132.5px)]" data-name="upload file thing">
      ...
      <p className="-translate-x-1/2 absolute font-['Satoshi_Variable:Regular',sans-serif] font-normal leading-[normal] left-[240px] text-[#000001] text-[24px] text-center top-[378px]">{`File format : PLY, Max ~2 GB `}</p>
